...
-- Task 6 - List all employees and the names of their managers.  -- no manager attribute in present entities
...
-- Task 9 - Combine the first names of employees and customers into a single list.    --- no customer entity

-- Task 10 - Find the names of employees who have placed the highest number of orders.  -- orders attribute is not present
